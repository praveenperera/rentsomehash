...
secondaryCtaLabel: "Alternative guides"
...
highlights:
  ...
  - title: "Alternative guides are there if you already run home hardware"
    body: "If you already trust a home box more than a fresh VPS, use the StartOS or Umbrel route and expose DATUM from the box you already run."
warnings:
...
Start with the main route if you want the shortest path and are happy to spin up a Linux VPS just for this. If you already run StartOS or Umbrel, skip to the alternative guides and reuse what you already have.
